        ...
        <>
            <div className="flex flex-col items-center justify-center bg-white w-full">
                ...
                <div className="flex flex-col items-center justify-around mt-[3rem] w-full">
                    <div className="flex flex-col items-center bg-[#ecebe7] w-full p-24 font-RobotoSlab">
                        <div className="flex flex-col items-center">
                            <span className="font-MsMadi text-3xl">I believe,</span>
                            <span className="text-2xl mr-1 border-b border-red-500">Good code is its own best documentation.</span>
                            <span>As you’re about to add a comment, ask yourself,</span>
                            <span>“How can I improve the code so that this comment isn’t needed?”</span>
                        </div>
